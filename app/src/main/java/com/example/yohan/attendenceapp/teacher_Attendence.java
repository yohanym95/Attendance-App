...
public class teacher_Attendence extends AppCompatActivity implements StuAttendanceAdapter.onItemClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDate = findViewById(R.id.tvteaDate);
        ...
        CBPst = findViewById(R.id.teaattendanceCBPST);
        CBSppm = findViewById(R.id.teaattendanceCBSSPE);
        recyclerView = findViewById(R.id.rvteaAttendance);
    ...
    private void parseJson(final String date, final String course) {
        String url = Constants.URL_GET_TEACHER_ATTENDANCE;
